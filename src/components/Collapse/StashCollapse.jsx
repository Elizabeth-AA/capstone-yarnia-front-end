...
const StashCollapse = ({ stash }) => {
    ...
    const toProjects = (item) => {
        navigate('/yarn/:id', { id: item.rav_id })
    }
        ...
        >
            ...
            <div className="collapse-content rounded-b bg-primary px-2">
                ...
                <div className="flex flex-wrap pt-2">
                    ...
                    <button tabIndex={0} onClick={() => toProjects(item)} className="mt-3 btn btn-xs btn-block btn-outline btn-secondary">suggest projects</button>
                </div>
            </div>
        </div>
    ))}
